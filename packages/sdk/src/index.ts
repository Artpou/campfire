...
export type User = InferResponseType<(typeof api.users)[":id"]["$get"]>;
export type AuthUser = InferResponseType<(typeof api.auth)["me"]["$get"]>;
...
export type IndexerManager = InferResponseType<(typeof api)["indexer-manager"]["$get"]>[number];
