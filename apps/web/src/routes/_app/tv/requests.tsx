...
export const Route = createFileRoute("/_app/tv/requests")({
  component: TvRequestsPage,
});

function TvRequestsPage() {
  const { data, fetchNextPage, hasNextPage, isFetchingNextPage, isPending } = useInfiniteQuery(
    requestQueries.list({ type: "tv" }),
  );
