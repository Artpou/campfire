    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          class="bg-card text-card-foreground w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
...
function SidebarMenuSkeleton({
  ...
  return (
    <div
      ...
      {...props}
    >
      {showIcon && <Skeleton class="size-4" data-sidebar="menu-skeleton-icon" />}
      <Skeleton
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      class={cn(
        "border-sidebar-border ml-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l pl-1 pr-0 py-0.5",
        "group-data-[collapsible=icon]:hidden",
        className,
      )}
      {...props}
